...
def plot_diag(res, d1=True, d2=True, ylim=None):
    ...
    if d2:
        ...
        for i in range(1,len(diags)):
            for j in range(i):
                ...
                P.cla()
                P.contourf(*plots.partial_dependence(res.space, res.models[-1], diags[i], diags[j], n_points=10), cmap='gist_earth_r', levels=levels)
